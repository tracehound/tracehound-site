...
export function ProblemSection() {
  return (
    <section className="relative w-full py-16 lg:py-24 xl:py-40">
      ...
      <header className="flex flex-col mb-10 lg:mb-12 xl:mb-15 xl:max-w-200">
        ...
        <p className="font-sans font-light text-lg md:text-2xl xl:text-[32px]">
          Traditional WAFs and RASP solutions stop threats — but often stop your application in the
          process.
        </p>
      </header>

      <article className="grid grid-cols-1 gap-12 lg:gap-y-24 items-start lg:grid-cols-2 xl:grid-cols-3">
