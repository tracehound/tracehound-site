    ...
    <div className="flex flex-col min-h-screen px-6 xl:px-12">
      <header className="w-full flex flex-col pb-6 xl:pb-12">
        ...
        <p className="font-sans font-light text-lg md:text-xl xl:text-2xl">
          This document outlines the deterministic security boundaries, predictable failure modes,
          and legal/liability constraints of the Tracehound Resilience Edge. It is designed to
          provide a clear understanding of the product's operational behavior under extreme duress.
        </p>
      </header>
